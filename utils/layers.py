# Adapted from https://github.com/bowang-lab/CongFu/tree/main
...
class GINEConv(MessagePassing):
    ...
    def __init__(self, input_dim: int, output_dim: int, num_bond_type: int, num_bond_direction: int, dropout_prob: float) -> None:
        super().__init__()
    ...
    def forward(self, x: torch.Tensor, edge_index: torch.Tensor, edge_attr: torch.Tensor) -> torch.Tensor:
        ...
        edge_embeddings1 = self.edge_embedding1(edge_attr[:, 0])
        edge_embeddings2 = self.edge_embedding2(edge_attr[:, 1])
        edge_embeddings = edge_embeddings1 + edge_embeddings2
